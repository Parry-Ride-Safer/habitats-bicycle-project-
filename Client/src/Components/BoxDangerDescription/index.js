    ...
    return (
        <div className={`${isDangerDescriptionOpen ? 'show-danger-box' : 'danger-box-overlay'}`}>
            <form className="danger-form-display" onSubmit={dangerFormSubmit}>
                ...
                <input className="danger-input-fields" type="text" name="title" value={dangerDescriptionInputs.title} onChange={handleDangerDescriptionInputs}/>
                <p className="danger-input-labels"> Picture </p>
                <p>Submit your picture</p>
                <p className="danger-input-labels"> Danger Description </p>
                <input className="danger-input-fields" id="danger-description-input-field" type="text" name="description" value={dangerDescriptionInputs.description} onChange={handleDangerDescriptionInputs}/><br/>
